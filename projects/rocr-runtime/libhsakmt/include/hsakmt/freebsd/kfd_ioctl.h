// I have no idea what Liscense to put here?
// Sourojeet Adhikari
// FreeBSD Foundation
...
struct kfd_ioctl_get_version_args {
	__uint32_t major_version;	/* from KFD */
	__uint32_t minor_version;	/* from KFD */
};
...
struct kfd_ioctl_create_queue_args {
	__uint64_t ring_base_address;	/* to KFD */
	__uint64_t write_pointer_address;	/* to KFD */
	__uint64_t read_pointer_address;	/* to KFD */
	__uint64_t doorbell_offset;	/* from KFD */

	__uint32_t ring_size;		/* to KFD */
	__uint32_t gpu_id;		/* to KFD */
	__uint32_t queue_type;		/* to KFD */
	__uint32_t queue_percentage;	/* to KFD */
	__uint32_t queue_priority;	/* to KFD */
	__uint32_t queue_id;		/* from KFD */

	__uint64_t eop_buffer_address;	/* to KFD */
	__uint64_t eop_buffer_size;	/* to KFD */
	__uint64_t ctx_save_restore_address; /* to KFD */
	__uint32_t ctx_save_restore_size;	/* to KFD */
	__uint32_t ctl_stack_size;		/* to KFD */
	__uint32_t sdma_engine_id;		/* to KFD */
	__uint32_t metadata_ring_size;		/* to KFD */
};

struct kfd_ioctl_destroy_queue_args {
	__uint32_t queue_id;		/* to KFD */
	__uint32_t pad;
};
...
struct kfd_ioctl_set_cu_mask_args {
	__uint32_t queue_id;		/* to KFD */
	__uint32_t num_cu_mask;		/* to KFD */
	__uint64_t cu_mask_ptr;		/* to KFD */
};

struct kfd_ioctl_get_queue_wave_state_args {
	__uint64_t ctl_stack_address;	/* to KFD */
	__uint32_t ctl_stack_used_size;	/* from KFD */
	__uint32_t save_area_used_size;	/* from KFD */
	__uint32_t queue_id;			/* to KFD */
	__uint32_t pad;
};

struct kfd_queue_snapshot_entry {
	__uint64_t exception_status;
	__uint64_t ring_base_address;
	__uint64_t write_pointer_address;
	__uint64_t read_pointer_address;
	__uint64_t ctx_save_restore_address;
	__uint32_t queue_id;
	__uint32_t gpu_id;
	__uint32_t ring_size;
	__uint32_t queue_type;
	__uint32_t ctx_save_restore_area_size;
	__uint32_t reserved;
};
...
struct kfd_dbg_device_info_entry {
	__uint64_t exception_status;
	__uint64_t lds_base;
	__uint64_t lds_limit;
	__uint64_t scratch_base;
	__uint64_t scratch_limit;
	__uint64_t gpuvm_base;
	__uint64_t gpuvm_limit;
	__uint32_t gpu_id;
	__uint32_t location_id;
	__uint32_t vendor_id;
	__uint32_t device_id;
	__uint32_t revision_id;
	__uint32_t subsystem_vendor_id;
	__uint32_t subsystem_device_id;
	__uint32_t fw_version;
	__uint32_t gfx_target_version;
	__uint32_t simd_count;
	__uint32_t max_waves_per_simd;
	__uint32_t array_count;
	__uint32_t simd_arrays_per_engine;
	__uint32_t num_xcc;
	__uint32_t capability;
	__uint32_t debug_prop;
};
...
struct kfd_ioctl_set_memory_policy_args {
	__uint64_t alternate_aperture_base;	/* to KFD */
	__uint64_t alternate_aperture_size;	/* to KFD */

	__uint32_t gpu_id;			/* to KFD */
	__uint32_t default_policy;		/* to KFD */
	__uint32_t alternate_policy;		/* to KFD */
	__uint32_t misc_process_flag;        /* to KFD */
};
...
struct kfd_ioctl_get_clock_counters_args {
	__uint64_t gpu_clock_counter;	/* from KFD */
	__uint64_t cpu_clock_counter;	/* from KFD */
	__uint64_t system_clock_counter;	/* from KFD */
	__uint64_t system_clock_freq;	/* from KFD */
...
struct kfd_process_device_apertures {
	__uint64_t lds_base;		/* from KFD */
	__uint64_t lds_limit;		/* from KFD */
	__uint64_t scratch_base;		/* from KFD */
	__uint64_t scratch_limit;		/* from KFD */
	__uint64_t gpuvm_base;		/* from KFD */
	__uint64_t gpuvm_limit;		/* from KFD */
	__uint32_t gpu_id;		/* from KFD */
	__uint32_t pad;
};
...
struct kfd_ioctl_get_process_apertures_new_args {
	 ...
	 * filled in by Kernel
	 */
	__uint64_t kfd_process_device_apertures_ptr;
...
struct kfd_ioctl_dbg_address_watch_args {
	__uint64_t content_ptr;		/* a pointer to the actual content */
	__uint32_t gpu_id;		/* to KFD */
	__uint32_t buf_size_in_bytes;	/*including gpu_id and buf_size */
};
...
struct kfd_runtime_info {
	__uint64_t r_debug;
	__uint32_t runtime_state;
	__uint32_t ttmp_setup;
};
...
struct kfd_ioctl_runtime_enable_args {
	__uint64_t r_debug;
	__uint32_t mode_mask;
	__uint32_t capabilities_mask;
};

/* Context save area header information */
struct kfd_context_save_area_header {
	struct {
		__uint32_t control_stack_offset;
		__uint32_t control_stack_size;
		__uint32_t wave_state_offset;
		__uint32_t wave_state_size;
	} wave_state;
	__uint32_t debug_offset;
	__uint32_t debug_size;
	__uint64_t err_payload_addr;
	__uint32_t err_event_id;
...
struct kfd_ioctl_dbg_trap_enable_args {
	...
	__uint64_t rinfo_ptr;
	__uint32_t rinfo_size;
	__uint32_t dbg_fd;
};
...
struct kfd_ioctl_dbg_trap_set_wave_launch_override_args {
	__uint32_t override_mode;
	__uint32_t enable_mask;
	__uint32_t support_request_mask;
	__uint32_t pad;
};
...
struct kfd_ioctl_dbg_trap_suspend_queues_args {
	__uint64_t exception_mask;
	__uint64_t queue_array_ptr;
	__uint32_t num_queues;
	__uint32_t grace_period;
};
...
struct kfd_ioctl_dbg_trap_query_exception_info_args {
	__uint64_t info_ptr;
	__uint32_t info_size;
	__uint32_t source_id;
	__uint32_t exception_code;
	__uint32_t clear_exception;
};
...
struct kfd_ioctl_dbg_trap_queue_snapshot_args {
	__uint64_t exception_mask;
	__uint64_t snapshot_buf_ptr;
	__uint32_t num_queues;
	__uint32_t entry_size;
};
...
struct kfd_ioctl_create_event_args {
	__uint64_t event_page_offset;	/* from KFD */
	__uint32_t event_trigger_data;	/* from KFD - signal events only */
	__uint32_t event_type;		/* to KFD */
	__uint32_t auto_reset;		/* to KFD */
	__uint32_t node_id;		/* to KFD - only valid for certain
							event types */
	__uint32_t event_id;		/* from KFD */
	__uint32_t event_slot_index;	/* from KFD */
};

struct kfd_ioctl_destroy_event_args {
	__uint32_t event_id;		/* to KFD */
	__uint32_t pad;
};
...
struct kfd_memory_exception_failure {
	__uint32_t NotPresent;	/* Page not present or supervisor privilege */
	__uint32_t ReadOnly;	/* Write access to a read-only page */
	__uint32_t NoExecute;	/* Execute access to a page marked NX */
	__uint32_t imprecise;	/* Can't determine the	exact fault address */
};
...
struct kfd_hsa_memory_exception_data {
	...
	__uint64_t va;
	__uint32_t gpu_id;
	__uint32_t ErrorType; /* 0 = no RAS error,
			  * 1 = ECC_SRAM,
...
struct kfd_hsa_hw_exception_data {
	__uint32_t reset_type;
	__uint32_t reset_cause;
	__uint32_t memory_lost;
	__uint32_t gpu_id;
};

/* hsa signal event data */
struct kfd_hsa_signal_event_data {
	__uint64_t last_event_age;	/* to and from KFD */
};
...
struct kfd_event_data {
	...
	__uint64_t kfd_event_data_ext;	/* pointer to an extension structure
...
struct kfd_ioctl_wait_events_args {
	__uint64_t events_ptr;		/* pointed to struct
					   kfd_event_data array, to KFD */
	__uint32_t num_events;		/* to KFD */
	__uint32_t wait_for_all;		/* to KFD */
	__uint32_t timeout;		/* to KFD */
	__uint32_t wait_result;		/* from KFD */
};

struct kfd_ioctl_set_scratch_backing_va_args {
	__uint64_t va_addr;	/* to KFD */
	__uint32_t gpu_id;	/* to KFD */
	__uint32_t pad;
};
...
struct kfd_ioctl_get_tile_config_args {
	...
	__uint64_t tile_config_ptr;
	/* to KFD: pointer to macro tile array */
	__uint64_t macro_tile_config_ptr;
	/* to KFD: array size allocated by user mode
	 * from KFD: array size filled by kernel
	 */
	__uint32_t num_tile_configs;
	/* to KFD: array size allocated by user mode
	 * from KFD: array size filled by kernel
	 */
	__uint32_t num_macro_tile_configs;

	__uint32_t gpu_id;		/* to KFD */
	__uint32_t gb_addr_config;	/* from KFD */
	__uint32_t num_banks;		/* from KFD */
	__uint32_t num_ranks;		/* from KFD */
...
struct kfd_ioctl_set_trap_handler_args {
	__uint64_t tba_addr;		/* to KFD */
	__uint64_t tma_addr;		/* to KFD */
	__uint32_t gpu_id;		/* to KFD */
	__uint32_t pad;
};

struct kfd_ioctl_acquire_vm_args {
	__uint32_t drm_fd;	/* to KFD */
	__uint32_t gpu_id;	/* to KFD */
};
...
struct kfd_ioctl_alloc_memory_of_gpu_args {
	__uint64_t va_addr;		/* to KFD */
	__uint64_t size;		/* to KFD */
	__uint64_t handle;		/* from KFD */
	__uint64_t mmap_offset;	/* to KFD (userptr), from KFD (mmap offset) */
	__uint32_t gpu_id;		/* to KFD */
	__uint32_t flags;
};
 ...
 *
 * @handle:                memory handle returned by alloc
 * @device_ids_array_ptr:  array of gpu_ids (__uint32_t per device)
...
struct kfd_ioctl_map_memory_to_gpu_args {
	__uint64_t handle;			/* to KFD */
	__uint64_t device_ids_array_ptr;	/* to KFD */
	__uint32_t n_devices;		/* to KFD */
	__uint32_t n_success;		/* to/from KFD */
};
...
struct kfd_ioctl_alloc_queue_gws_args {
	__uint32_t queue_id;		/* to KFD */
	__uint32_t num_gws;		/* to KFD */
	__uint32_t first_gws;	/* from KFD */
	__uint32_t pad;
};

struct kfd_ioctl_get_dmabuf_info_args {
	__uint64_t size;		/* from KFD */
	__uint64_t metadata_ptr;	/* to KFD */
	__uint32_t metadata_size;	/* to KFD (space allocated by user)
				 * from KFD (actual metadata size)
				 */
	__uint32_t gpu_id;	/* from KFD */
	__uint32_t flags;		/* from KFD (KFD_IOC_ALLOC_MEM_FLAGS) */
	__uint32_t dmabuf_fd;	/* to KFD */
};
...
struct kfd_ioctl_export_dmabuf_args {
	__uint64_t handle;		/* to KFD */
	__uint32_t flags;		/* to KFD */
	__uint32_t dmabuf_fd;	/* from KFD */
};
...
struct kfd_ioctl_smi_events_args {
	__uint32_t gpuid;	/* to KFD */
	__uint32_t anon_fd;	/* from KFD */
};
...
struct kfd_ioctl_spm_args {
	...
	__uint32_t timeout;
	__uint32_t gpu_id;
	__uint32_t bytes_copied;
	__uint32_t has_data_loss;
};
...
struct kfd_ioctl_spm_buffer_header {
	__uint32_t version; /* 0-23: minor 24-31: major */
	__uint32_t bytes_copied;
	__uint32_t has_data_loss;
	__uint32_t reserved[5];
};
...
struct kfd_ioctl_criu_args {
	__uint64_t devices;		/* Used during ops: CHECKPOINT, RESTORE */
	__uint64_t bos;		/* Used during ops: CHECKPOINT, RESTORE */
	__uint64_t priv_data;	/* Used during ops: CHECKPOINT, RESTORE */
	__uint64_t priv_data_size;	/* Used during ops: PROCESS_INFO, RESTORE */
	__uint32_t num_devices;	/* Used during ops: PROCESS_INFO, RESTORE */
	__uint32_t num_bos;		/* Used during ops: PROCESS_INFO, RESTORE */
	__uint32_t num_objects;	/* Used during ops: PROCESS_INFO, RESTORE */
	__uint32_t pid;		/* Used during ops: PROCESS_INFO, RESUME */
	__uint32_t op;
};

struct kfd_criu_device_bucket {
	__uint32_t user_gpu_id;
	__uint32_t actual_gpu_id;
	__uint32_t drm_fd;
	__uint32_t pad;
};
...
struct kfd_criu_bo_bucket {
	...
	__uint64_t size;
	__uint64_t offset;
	__uint64_t restored_offset;    /* During restore, updated offset for BO */
	__uint32_t gpu_id;             /* This is the user_gpu_id */
	__uint32_t alloc_flags;
	__uint32_t dmabuf_fd;
	__uint32_t pad;
};
...
struct kfd_ioctl_ipc_export_handle_args {
	__uint64_t handle;		/* to KFD */
	__uint32_t share_handle[4];	/* from KFD */
	__uint32_t gpu_id;		/* to KFD */
	__uint32_t flags;		/* to KFD */
};
...
struct kfd_ioctl_ipc_import_handle_args {
	__uint64_t handle;		/* from KFD */
	__uint64_t va_addr;		/* to KFD */
	__uint64_t mmap_offset;	/* from KFD */
	__uint32_t share_handle[4];	/* to KFD */
	__uint32_t gpu_id;		/* to KFD */
	__uint32_t flags;		/* from KFD */
};
...
struct kfd_ioctl_cross_memory_copy_args {
	...
	__uint64_t src_mem_range_array;
	/* to KFD: Size of above array */
	__uint64_t src_mem_array_size;
	/* to KFD: Destination GPU VM range */
	__uint64_t dst_mem_range_array;
	/* to KFD: Size of above array */
	__uint64_t dst_mem_array_size;
	/* from KFD: Total amount of bytes copied */
	__uint64_t bytes_copied;
};
...
struct kfd_pc_sample_info {
	__uint64_t interval;      /* [IN] if PCS_TYPE_INTERVAL_US: sample interval in us
	                      ...
	                      */
	__uint64_t interval_min;  /* [OUT] */
	__uint64_t interval_max;  /* [OUT] */
	__uint64_t flags;         /* [OUT] indicate potential restrictions e.g FLAG_POWER_OF_2 */
...
struct kfd_ioctl_pc_sample_args {
	__uint64_t sample_info_ptr;   /* array of kfd_pc_sample_info */
	__uint32_t num_sample_info;
	__uint32_t op;                /* kfd_ioctl_pc_sample_op */
	__uint32_t gpu_id;
	__uint32_t trace_id;
	__uint32_t flags;             /* kfd_ioctl_pcs_query flags */
	__uint32_t reserved;
};
...
struct kfd_ioctl_pmc_settings {
	__uint32_t gpu_id;             /* This is the user_gpu_id */
	__uint32_t lock;               /* Lock GPU for Profiling */
	__uint32_t perfcount_enable;   /* Force Perfcount Enable for queues on GPU */
};

struct kfd_ioctl_profiler_args {
	__uint32_t op;					/* kfd_profiler_op */
	union {
		struct kfd_ioctl_pc_sample_args pc_sample;
		struct kfd_ioctl_pmc_settings  pmc;
		__uint32_t version;				/* KFD_IOC_PROFILER_VERSION_NUM */
	};
};
...
struct kfd_ais_in_args {
	__uint64_t handle;         /* to KFD */
	__uint64_t handle_offset;  /* to KFD */
	__int64_t file_offset;    /* to KFD */
	__uint64_t size;           /* to KFD */
	__uint32_t op;             /* to KFD */
	__int32_t fd;             /* to KFD */
};
...
struct  kfd_ais_out_args {
	__uint64_t size_copied;     /* from KFD */
	__int32_t status;          /* from KFD */
	__int32_t pad;             /* unused */
};
